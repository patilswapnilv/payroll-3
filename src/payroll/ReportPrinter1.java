...
public class ReportPrinter1 implements Printable {
    ...
    public ReportPrinter1(Main parent, ArrayList<Worker> selected, ArrayList<Transaction> transactions, ArrayList<ReportCalculation> calculations, ArrayList<ReportSaving> savings, ArrayList<ReportSalary> salaries, Hashtable dates) {
        this.parent = parent;
